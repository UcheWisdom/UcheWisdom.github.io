      ...
      <div className="w-full grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
        ...
        <div>
          ...
          >
            ...
            technologies, API development, cloud-native applications, and database design. Passionate 
            about leveraging technology to build impactful products and always eager to take on new challenges. 
            Currently open to exciting opportunities in software engineering and technology.
          ...
          >
            ...
            <a href="https://github.com/uchewisdom"
              ...
              className="w-10 h-10 flex items-center justify-center border border-textDim/30 rounded-lg text-textDim hover:text-accent hover:border-accent transition-colors duration-200"
            >
            ...
            <a href="https://www.youtube.com/@UCHEBUAKUWISDOM"
              target="_blank"
              rel="noopener noreferrer"
              className="w-10 h-10 flex items-center justify-center border border-textDim/30 rounded-lg text-textDim hover:text-accent hover:border-accent transition-colors duration-200"
            >
