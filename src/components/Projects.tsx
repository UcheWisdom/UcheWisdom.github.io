          ...
          <div className="flex gap-6 w-max">
            {projects.map((project, index) => (
              <motion.div
                ...
                className="w-[380px] bg-secondary border border-textDim/10 rounded-lg overflow-hidden flex flex-col hover:border-accent/30 hover:translate-y-[-4px] transition-all duration-300 group flex-shrink-0"
              >
                {/* Project Image */}
                ...
                <div className="p-6 flex flex-col flex-1">
                  ...
                  <div className="flex items-center justify-end gap-4 mb-4">
                    ...
                    <a href={project.githubUrl}
                      ...
                      className="text-textDim hover:text-accent transition-colors duration-200"
